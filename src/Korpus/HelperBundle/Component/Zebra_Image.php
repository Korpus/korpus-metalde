                ...
                // aspect ratio needs to be preserved AND
                    ...
                    switch ($method) {
                        ...
                        case ZEBRA_IMAGE_CROP_TOPLEFT:
                            ...
                            // crop accordingly
                            return $this->crop(
                                            0, 0, $width, $height, $target_identifier // crop this resource instead
                            );
                        ...
                        case ZEBRA_IMAGE_CROP_TOPCENTER:
                            ...
                            // crop accordingly
                            return $this->crop(
                                            floor(($target_width - $width) / 2), 0, floor(($target_width - $width) / 2) + $width, $height, $target_identifier // crop this resource instead
                            );
                        ...
                        case ZEBRA_IMAGE_CROP_TOPRIGHT:
                            ...
                            // crop accordingly
                            return $this->crop(
                                            $target_width - $width, 0, $target_width, $height, $target_identifier // crop this resource instead
                            );
                    ...
                    $target_identifier = $this->_prepare_image(
                            ($width > 0 && $height > 0 && $method != ZEBRA_IMAGE_NOT_BOXED ? $width : $target_width), ($width > 0 && $height > 0 && $method != ZEBRA_IMAGE_NOT_BOXED ? $height : $target_height), $background_color
                    );
    ...
    function _prepare_image($width, $height, $background_color = '#FFFFFF')
    {
        ...
        if ($this->target_type == 'png' && $background_color == -1) {
            ...
            $transparent_color = imagecolorallocate(
                    $identifier, $this->source_transparent_color['red'], $this->source_transparent_color['green'], $this->source_transparent_color['blue']
            );
